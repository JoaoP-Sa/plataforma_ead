<?php       
    ...
    $sql_query_admin = $pdo->query("SELECT * FROM usuarios WHERE id = '$id_usuario'") or die($pdo->errorInfo());
    $dados_usuario = $sql_query_admin->fetch();

    if (!is_array($dados_usuario))
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <li class="header-notification">
                                <a href="#!">
                                    <i class="ti-money"></i> <?php echo number_format($dados_usuario['creditos'], 2, ',', '.'); ?>
                                </a>
                            </li>
