...
if(isset($_POST['email'])) {
    ...
    $email = $_POST['email'];
    $sql_query = $pdo->prepare("SELECT id, nome FROM usuarios WHERE email = ?");
    ...
    if($result['id']) {
        ...
        $sql_query = $pdo->prepare("UPDATE usuarios SET senha = ? WHERE id = ?");
        $sql_query->execute([$nova_senha_criptografada, $id_usuario]);
